...
function Projects() {
  ...
  return (
    <motion.div
      ...
      <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>Projects <span className='underline underline-offset-4 under font-light'>Completed</span></h1>
      <p className='text-center text-gray-500 mb-8 max-w-100 mx-auto'>Crafting Spaces, Building Legecies - Explore Our Portfolio</p>
          ...
          {projectsData.map((project, index) => (
            <div key={index} className='relative flex-shrink-0 w-full sm:w-1/4'>
              ...
              <div className='absolute left-0 right-0 bottom-5 flex justify-center'>
                <div className='inlinee-block bg-white w-3/4 px-4 py-2 shadow-md'>
